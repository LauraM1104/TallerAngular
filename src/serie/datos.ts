...
export const series: Serie[] = [
  ...
  new Serie(3, "Game of Thrones", "HBO", 7, 
    ...
    "https://m.media-amazon.com/images/M/MV5BOGY3NTg1ODMtOGIzZS00YWFiLTgzYzktNzBiYWZkYjcwNGRhXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg"),
  ...
  new Serie(6, "A Very English Scandal", "BBC", 2, 
    "A fact-based three-part British television comedy-drama miniseries based on John Preston's book of the same name.", 
    "https://www.bbc.co.uk/programmes/p065smy4", 
    "https://m.media-amazon.com/images/M/MV5BNTQ5NDI0MTQ0MV5BMl5BanBnXkFtZTgwNDEzNTc1NTM@._V1_FMjpg_UX1000_.jpg")
];